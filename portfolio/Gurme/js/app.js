(() => {
    ...
    function initSliders() {
        if (document.querySelector(".stocks-slider-main")) new core(".stocks-slider-main", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 4,
            ...
            lazy: true,
            navigation: {
                prevEl: ".stocks-main-btn-prev",
                nextEl: ".stocks-main-btn-next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
        ...
        if (document.querySelector(".left-slider-stocks__slider")) new core(".left-slider-stocks__slider", {
            ...
            navigation: {
                ...
                nextEl: ".left-slider-stocks-bnt-next"
            },
            on: {}
        });
        if (document.querySelector(".specialprice__slider")) new core(".specialprice__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
